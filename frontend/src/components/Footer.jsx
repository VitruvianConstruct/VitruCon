    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          <div className="md:col-span-5">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <div className="font-serif text-xl text-bone">Vitruvian Construct</div>
                <div className="font-mono text-[10px] tracking-[0.32em] uppercase text-bone-mute">
                  Studio · Atelier · Workshop
                </div>
              </div>
            </div>
            <p className="font-mono text-xs text-bone-dim leading-loose max-w-md">
              An independent studio assembling slow games like field notebooks. Built in
              draughty rooms with very good light.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-gold/10 flex flex-col md:flex-row items-center justify-between gap-4 font-mono text-[10px] tracking-[0.28em] uppercase text-bone-mute">
          <span>© {new Date().getFullYear()} Vitruvian Construct · All plates reserved</span>
          <span className="text-gold/70">Opvs · I · MMXXVI</span>
      ...
      {/* enormous brand watermark */}
      <div className="mt-16 overflow-hidden">
        <div className="font-serif italic text-[15vw] leading-none text-center text-gold/10 select-none">
          Vitruvian Construct
        </div>
      </div>
    </footer>
